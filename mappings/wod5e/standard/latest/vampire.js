...
class MappingClass extends baseMapping {
    ...
    async createMappings() {
        ...
        this.setCalculated("Notes", await this.htmlToText(this.actor.system.notes));
        ...
        this.setCalculated("History", await this.htmlToText(this.actor.system.biography));
        ...
        this.setCalculated("Chronicle Tenets", await this.htmlToText(this.actor.system.headers.tenets));
        ...
        this.setCalculated("Clan Banes", await this.htmlToText(this.actor.items.filter(item => { return item.type === 'clan' })[0]?.system.bane));
