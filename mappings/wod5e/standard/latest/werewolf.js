...
class MappingClass extends baseMapping {
    ...
    async createMappings() {
        ...
        this.setCalculated("Chron", await this.htmlToText(this.actor.system.headers.chronicle));
        ...
        this.setCalculated("History", await this.htmlToText(this.actor.system.bio.history));
