...
class MappingClass extends baseMapping {
    ...
    async createMappings() {
        ...
        this.setCalculated("HPCurrent", this.actor.system.attributes.hp.value, this.omitChangeable);
        ...
        this.setCalculated("SlotsRemaining 19", this.actor.system.spells.spell1.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 20", this.actor.system.spells.spell2.max || "");
        this.setCalculated("SlotsRemaining 20", this.actor.system.spells.spell2.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 21", this.actor.system.spells.spell3.max || "");
        this.setCalculated("SlotsRemaining 21", this.actor.system.spells.spell3.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 22", this.actor.system.spells.spell4.max || "");
        this.setCalculated("SlotsRemaining 22", this.actor.system.spells.spell4.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 23", this.actor.system.spells.spell5.max || "");
        this.setCalculated("SlotsRemaining 23", this.actor.system.spells.spell5.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 24", this.actor.system.spells.spell6.max || "");
        this.setCalculated("SlotsRemaining 24", this.actor.system.spells.spell6.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 25", this.actor.system.spells.spell7.max || "");
        this.setCalculated("SlotsRemaining 25", this.actor.system.spells.spell7.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 26", this.actor.system.spells.spell8.max || "");
        this.setCalculated("SlotsRemaining 26", this.actor.system.spells.spell8.value || "", this.omitChangeable);
        this.setCalculated("SlotsTotal 27", this.actor.system.spells.spell9.max || "");
        this.setCalculated("SlotsRemaining 27", this.actor.system.spells.spell9.value || "", this.omitChangeable);
